...
min_price <- map_df(profit_summary_price, `[`, c("min_inflation_adjusted_profit"))
mean_price <- map_df(profit_summary_price, `[`, c("mean_inflation_adjusted_profit"))
max_price <- map_df(profit_summary_price, `[`, c("max_inflation_adjusted_profit"))
...
price_df <- data.frame(
  ...
  pivot_longer(everything(), values_to = "inflation_adjusted_profit", names_to = "parameter")

# Plot results
ggplot(price_df, aes(as.factor(parameter), inflation_adjusted_profit, group = parameter)) +
  geom_boxplot() +
  labs(y = "Price",
       x = "Parameter")
```
