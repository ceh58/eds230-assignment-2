...
results_df <- data.frame(
  min_profit = min_price$min_inflation_adjusted_profit,
  mean_profit = mean_price$mean_inflation_adjusted_profit,
  max_profit = max_price$max_inflation_adjusted_profit
) %>% 
